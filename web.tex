...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]{Request-response}
        \begin{figure}
            \centering
            \includegraphics[width=0.75\textwidth]{images/reqres.png}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=0.85\textwidth]{images/httpmsgstructure.png}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=0.85\textwidth]{images/url.png}
            \caption{URL}
            \label{fig:url}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}{Пример имплементације: Go/Gorilla Mux}
    \end{frame}
